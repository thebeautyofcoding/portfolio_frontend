<template>
  <form>
    ...
    <div class="mb-3">
      <label for="smaldescription" class="form-label">small description</label>
      <textarea
  ...
  export default {
    ...
    methods: {
      ...
      send(e) {
        ...
        this.data.smallDescription = this.smallDescription;
        formData.append("title", this.data.title);
        formData.append("description", this.data.description);
        formData.append("small_description", this.data.smallDescription);
        ...
        this.$store.dispatch("postSkill", formData);
      },
    },
  };
</script>
